...
export const Paginator = ({
  ...
  const classes = {
    ...
    btnClass: "h-[24px] min-w-[24px] mx-1 rounded focus:outline-none disabled:text-zp-line",
    btnNext: "inline-flex w-[24px] px-2 items-center justify-center",
    btnPrev: "inline-flex px-2 w-[24px] items-center justify-center",
    item: " h-[24px] min-w-[24px] bg-primary-light cursor-pointer text-primary",
    itemActive: "!text-white !bg-[#470E81]",
  ...
  return (
    <div className={clsx(classes.paginator)}>
      <h3 className="text-xs">
        {`${pageNumbers[0]} - ${pageNumbers[pageNumbers.length - 1]} of ${totalPages}`}
      </h3>
      <button
        title="Previous"
        ...
        className={clsx([
          ...
          classes.btnPrev,
          leftArrowDisabled
            ? "cursor-not-allowed text-gray-500 border rounded border-[#ECEDEE]"
            : "cursor-pointer text-white bg-primary border rounded border-primary",
        ])}
      >
        <FaChevronLeft />
      </button>
      ...
      <button
        ...
        className={clsx([
          ...
          rightArrowDisabled
            ? "cursor-not-allowed text-gray-500 border rounded border-[#ECEDEE]"
            : "cursor-pointer text-white border bg-primary rounded border-primary",
        ])}
      >
        <FaChevronRight />
      </button>
